                    ...
                    <div v-if ="OptionDateTime" >
                        ...
                        <div class="flex justify-around mt-5 px-5">
                            <div class="">
                                ...
                                <Datepicker v-model="date" inline autoApply :minDate="new Date().toISOString().substr(0, 10)" 
                                    :disabledWeekDays="[0]"
...
export default {
 components: { Datepicker },
    ...
    methods:{
        ...
        savedate(){
            if(this.recentdate.getMonth()==this.date.getMonth() &&
                this.recentdate.getDate()==this.date.getDate() &&
                this.recentdate.getFullYear()==this.date.getFullYear()
                ){
        ...
        async addclearance(){
            ...
            const addedDocs = await setDoc(doc(db, "Clearance Requests",currendID ),{currendID, BCdate, BCtime, BCfirst, BCmiddle, BClast, BCsuffix, BCpurok, BCcitizenship, BCstatus, BCage, BCquantity, BCcedula, BCtotalcost, BCpurpose,BCreqstat});
